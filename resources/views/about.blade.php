...
<main class="main-content">
    <div class="container">
        <div class="page">
            ...
            <div class="row">
                <div class="col-md-4">
                    <figure><img src="{{ url('assets/dummy/figure.jpg') }}" alt="figure image"></figure>
                </div>
                <div class="col-md-8">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="team">
                        <figure class="team-image"><img src="{{ url('assets/dummy/person-1.jpg') }}" alt=""></figure>
                ...
                <div class="col-md-3">
                    <div class="team">
                        <figure class="team-image"><img src="{{ url('assets/dummy/person-2.jpg') }}" alt=""></figure>
                ...
                <div class="col-md-3">
                    <div class="team">
                        <figure class="team-image"><img src="{{ url('assets/dummy/person-3.jpg') }}" alt=""></figure>
                ...
                <div class="col-md-3">
                    <div class="team">
                        <figure class="team-image"><img src="{{ url('assets/dummy/person-4.jpg') }}" alt=""></figure>
                        <h2 class="team-name">Sarah Stuart</h2>
